...
<template>
  <!-- The layout's <main> is a clipped flex child (h-screen + overflow-hidden), so a page
       that grows past the viewport must own its own scroll or its tail is unreachable. -->
  <div data-test="settings-page" class="h-full overflow-y-auto">
